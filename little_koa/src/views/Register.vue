    ...
    <div class="itc-register-wrap">
        ...
        <div class="register-form">
          <div class="register-form-header">
            ...
            <div class="upload-avatar">
              ...
              <el-avatar :src="registerForm.avatar" :size="70" shape="square" v-show="registerForm.avatar"
          ...
          <div class="register-form-body">
              <el-form ref="registerForm" :model="registerForm" :rules="registerRules" label-width="80px" class="form-container">
                  <el-form-item prop="username">
                    <el-input v-model="registerForm.username" placeholder="昵称" prefix-icon="el-icon-star-off"
                              maxlength="10"/>
                  </el-form-item>
                  <el-form-item prop="id">
                    <el-input v-model="registerForm.id" placeholder="用户名" prefix-icon="el-icon-user"/>
                  </el-form-item>
                  ...
                  <el-form-item prop="re_password">
                    <el-input v-model="registerForm.re_password" placeholder="确认密码" prefix-icon="el-icon-lock"
                              show-password/>
                  </el-form-item>
                  <el-form-item prop="code">
                    <el-input placeholder="验证码" v-model="registerForm.code" prefix-icon="el-icon-key"
                              class="code_input"/>
                    <div class="code">
      ...
      <div class="cropper-img-box" v-if="cropper_box_mark === true">
        ...
        <div class="cropper-img-tool">
          <el-button type="warning" icon="el-icon-refresh-left" circle size="medium" @click="rotateRight"/>
          <el-button type="primary" icon="el-icon-close" circle size="medium" @click="cropper_box_mark = false"/>
          <el-button type="success" icon="el-icon-check" circle size="medium" @click="finish"/>
          <el-button type="warning" icon="el-icon-refresh-right" circle size="medium" @click="rotateLeft"/>
        </div>
        </div>
    </div>
  </template>
