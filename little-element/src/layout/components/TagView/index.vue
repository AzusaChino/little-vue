<template>
  <div id="tag-view-container" class="tag-view-container">
    <scroll-panel ref="scrollPanel" class="tag-view-wrapper" @scroll="handleScroll">
      <router-link
...
export default {
  ...
  methods: {
    ...
    closeOtherTags() {
      ...
      this.$store.dispatch('tagView/delOtherViews', this.selectedTag).then(() => {
        this.moveToCurrentTag()
      })
    },
    closeAllTags(view) {
    ...
    toLastView(visitedViews, view) {
      ...
      if (latestView) {
        ...
        // now the default is to redirect to the home page if there is no tag-view,
