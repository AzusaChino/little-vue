  ...
  <div class="home-wrap">
    ...
    <el-container>
      <el-aside width="200px" class="home-aside">
        <el-avatar :size="80" :src="user.avatar" class="aside-avatar"/>
          <div>{{dateNow}}{{user.username}}</div>
        ...
        <div class="main-header clearfix">
            <el-form :model="queryForm" label-width="80px">
              ...
              <el-form-item label="创建人">
                <el-input v-model="queryForm.creater" placeholder="请输入创建人名字" size="small" clearable/>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    isCurrentUser (row) {
      return row.creater === this.$store.state.user.username
    },
    pageChange (page) {
      this.pageNum = page
      this.getRecord()
