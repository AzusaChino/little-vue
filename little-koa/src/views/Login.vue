        ...
        <div class="login-form-body">
            <el-form ref="loginForm" :model="loginForm" label-width="80px" class="form-container" :rules="loginRules">
                <el-form-item prop="user_id">
                  <el-input v-model="loginForm.id" placeholder="用户名" prefix-icon="el-icon-user"/>
                </el-form-item>
                <el-form-item prop="user_pwd">
                  <el-input v-model="loginForm.password" placeholder="密码" prefix-icon="el-icon-lock" show-password/>
                </el-form-item>
                <el-form-item prop="code">
                  <el-input placeholder="验证码" v-model="loginForm.code" prefix-icon="el-icon-key" class="code_input"/>
                  <div class="code">
